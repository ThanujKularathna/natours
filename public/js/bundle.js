...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoidGhhbnVqMTEiLCJhIjoiY21hYXJ5aXc3MXdiZzJsc2Foemo2b3d0NyJ9.uHRsTQ8Vg0N1QOcowQLOOA';
...
var hideAlert = exports.hideAlert = function hideAlert() {
  ...
  if (el) el.parentElement.removeChild(el); // if (el) el.remove();
};
...
var stripe = Stripe('pk_test_51ROWwcH49y8rreKNrzw1PIe2drzkdhlPSahd124GNZq7HN3vVZtksPWuFTUt3JwaCm1csG8Bg3rCfLg3zRm3rRHM001OQG537F');
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 9:
          ...
          (0, _alert.showAlert)('error', _context.t0.message || 'Could not process payment. Please try again.');
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "7902" + '/');
